...
const COLOR = {
  ...
  // @ts-ignore TYPE NEEDS FIXING
  gradient: (checked) =>
    checked ? "bg-gradient-to-r from-blue to-pink" : "bg-taupe-200",
};
  ...
  return (
    <HeadlessUiSwitch
      ...
      className={classNames(
        `flex items-center bg-taupe-300 border border-taupe-200 relative inline-flex flex-shrink-0 rounded-full cursor-pointer ease-in-out duration-200 ${id}`
      )}
      style={{ height, width }}
    >
      <span
