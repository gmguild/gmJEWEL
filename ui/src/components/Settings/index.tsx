  ...
  return (
    <>
      <Popover
        ...
        content={
          <div className="flex flex-col gap-3 p-3 border rounded shadow-xl bg-taupe-400 w-80 border-taupe-200">
            <div className="flex flex-col gap-4 p-3 border rounded border-taupe-300/60">
            ...
            <div className="flex flex-col gap-3 p-3 border rounded border-taupe-300/60">
              <Typography variant="xxs" weight={700} className="text-secondary">
                {`Interface Settings`}
              </Typography>
