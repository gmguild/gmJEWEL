...
import { Currency, Price, ZERO } from "../../package";
  ...
  return (
    <div
      ...
      className={classNames(
        "flex w-full gap-1 cursor-pointer hover:text-white select-none",
        className
      )}
    >
      <Typography
        variant="xs"
        weight={700}
        className="flex gap-1 tracking-[0.06em] text-white"
      >
        1 {labelInverted} <span className="text-primary">=</span>{" "}
