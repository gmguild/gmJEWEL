        ...
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-row flex-wrap items-center justify-center text-sm space-x-2 my-2">
              ...
              <a className="block cursor-pointer" href="https://dexscreener.com/harmony/0x33af0e5bfa4552db2390c01e1f5646689037e04e" target="_blank" rel="noreferrer"><span className="text-gray-500">$GMG</span> {loadingPrices ? '...' : prices.gmgPriceInJewel?.toFixed(5)} JEWEL</a>
            </div>
          </div>
