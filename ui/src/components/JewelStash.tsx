  ...
  return (
    <div
      className={classNames(
        "bg-taupe cursor-pointer p-8 rounded-md shadow-lg border-rune-edge border-8 flex flex-col items-center justify-center",
    ...
    >
      ...
      />
      <div className="text-gray-100 flex flex-row items-center">
        <div className="jewel-icon h-4 w-4 mr-3" /> {formattedUtxoVal}
      </div>
